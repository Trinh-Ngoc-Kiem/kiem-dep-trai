...
class AuthenticatorAdmin extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    {
        $token = new CsrfToken('admin_login', $credentials['csrf_token']);
...
//        }
//
//        throw new \Exception('Phiên đăng nhập đã hết hạn. Mời bạn đăng nhập lại');
    }
